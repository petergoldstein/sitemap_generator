...
describe "SitemapGenerator" do
  ...
  describe "verbose" do
    it "should be set via ENV['VERBOSE']" do
      ...
      ENV['VERBOSE'] = 'true'
      expect(SitemapGenerator.verbose).to be_truthy
      SitemapGenerator.verbose = nil
      ENV['VERBOSE'] = 'false'
      expect(SitemapGenerator.verbose).to be_falsey
  ...
  describe "yield_sitemap" do
    it "should set the yield_sitemap flag" do
      ...
      expect(SitemapGenerator.yield_sitemap?).to be_falsey
      SitemapGenerator.yield_sitemap = true
      expect(SitemapGenerator.yield_sitemap?).to be_truthy
      SitemapGenerator.yield_sitemap = false
    end
  end
